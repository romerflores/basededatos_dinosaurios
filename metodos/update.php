...
if($existe_registro)
{
    ...
    $consulta_actualizar="UPDATE `ficha_tecnica` SET `nombre`='$nombre',`clasificacion`='$clasificacion',`longitud`='$longitud',`altura`='$altura',`peso`='$peso',`era`='$era',`habilidades`='$habilidades' WHERE id='$id'";
...
?>
<a href="../paginas/modificar.php?id=<?php echo $_REQUEST["id"]?>">
    <button class="btn btn-danger" value="Regresar">Regresar</button>
</a>
<a href="../paginas/mostrar.php">
    <button class="btn btn-success mx-4" value="Regresar">Cancelar</button>
</a>
