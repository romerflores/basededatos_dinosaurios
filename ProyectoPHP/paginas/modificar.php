...
if(isset($_REQUEST["id"]))
{
    ...
    $id=$_REQUEST["id"];
    $consulta_modificar="SELECT * FROM `ficha_tecnica` where id=$id";
    $resultado = mysqli_query($conexion, $consulta_modificar) or die("no se ha podido realizar el registro");
...
<div style="display: flex;flex-wrap: wrap;width: 100%;height: 100%;padding: 2%;justify-content: center;">
    <div class="caja_formulario">
        <form action="../metodos/update.php" method="REQUEST" style="width: 100%;height: 80%">
            <div class="titulo" style="display: flex;justify-content: center;align-content: center;width: 100%;height: 10%;margin-top: 10px">
                <h1 style="background-color: aliceblue;border-radius: 10px;font-family: 'Comic Sans MS' ;">MODIFICAR DATOS</h1>
            </div>
            <div class="entradas">
                <input name="id" type="hidden" value="<?php echo $columna['id']?>" >
                <div class="entrada">
                    <label for="nombre">Nombre</label>
                    <input name="nombre" type="text" value="<?php echo $columna['nombre']?>">
                </div>
                <div class="entrada">
                ...
                <div class="entrada">
                    ...
                    <input name="longitud" type="number" placeholder="0" value="<?php echo $columna['longitud']?>">
                </div>
                <div class="entrada">
                    <label for="altura">Altura</label>
                    <input name="altura" type="number" value="<?php echo $columna['altura']?>">
                </div>
                <div class="entrada">
                    <label for="peso">Peso</label>
                    <input name="peso" type="text" value="<?php echo $columna['peso']?>">
                </div>
                <div class="entrada">
                ...
                <div class="entrada">
                    ...
                    <div class="opciones">
                        <div class="opcion">
                            ...
                            <input type="checkbox" name="velocidad" checked>
                        </div>
